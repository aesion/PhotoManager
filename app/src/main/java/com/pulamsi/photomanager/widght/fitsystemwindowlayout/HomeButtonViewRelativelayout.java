...
public class HomeButtonViewRelativelayout extends RelativeLayout {
    /**
     * 动画持续时长
     */
    ...
    public HomeButtonViewRelativelayout(Context paramContext) {
        this(paramContext, null);
    }


    public HomeButtonViewRelativelayout(Context paramContext, AttributeSet paramAttributeSet) {
        this(paramContext, paramAttributeSet, 0);
    }

    public HomeButtonViewRelativelayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
                ...
                if (!hasDoneAnimation) {
                    ...
                    post(new Runnable() {
                        ...
                        public void run() {
                             ...
                             */
                            if (listener != null) {
                                listener.onClick(HomeButtonViewRelativelayout.this);
                            }
                        }
                    });
                }
