...
public class GridRecyclerViewAdapter extends RecyclerView.Adapter implements OnItemMovedListener {
    List<Galleryclass> myChannels, otherChannels;
    ...
    public GridRecyclerViewAdapter(List<Galleryclass> myChannels, List<Galleryclass> otherChannels, ItemTouchHelper itemTouchHelper) {
        this.myChannels = myChannels;
        this.otherChannels = otherChannels;
        this.itemTouchHelper = itemTouchHelper;
    }

    public List<Galleryclass> getMyChannels() {
        return myChannels;
    }

    public void setMyChannels(List<Galleryclass> myChannels) {
        this.myChannels = myChannels;
    }

    public List<Galleryclass> getOtherChannels() {
        return otherChannels;
    }

    public void setOtherChannels(List<Galleryclass> otherChannels) {
        this.otherChannels = otherChannels;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_HEADER:
                return new Holder(mHeaderView);//固定的头部
            case MY_CHANNELS:
                ...
                myChannelViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (onItemClickListener != null && !isEditMode){
                        int position = myChannelViewHolder.getAdapterPosition();
                        onItemClickListener.onItemClick(myChannelViewHolder.itemView, position);
                        }
                    }
                });
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MyChannelViewHolder) {
            ((MyChannelViewHolder) holder).nameTv.setText(myChannels.get(position - 1).getCatName());
            if (isEditMode) {
            ...
            ((OthersViewHolder) holder).nameTv.setText(otherChannels.get(position - 2 - myChannels.size()).getCatName());
            ...
            ((MyChannelHeaderViewHolder) holder).editTextView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                  ...
                  if (((TextView)v).getText().equals("完成")){
//                      for (Galleryclass galleryclass : getMyChannels()) {
//                          Log.e("",galleryclass.getCatName());
//                      }
                  }
    ...
    private void moveMineToOthers(RecyclerView.ViewHolder viewHolder) {
        ...
        Galleryclass entity = myChannels.get(startPosition);
    ...
    private void moveOthersToMine(RecyclerView.ViewHolder viewHolder) {
        ...
        Galleryclass entity = otherChannels.get(startPosition);
    ...
    public void onItemMoved(int fromPosition, int toPosition) {
        Galleryclass channelEntity = myChannels.get(fromPosition - 1);
